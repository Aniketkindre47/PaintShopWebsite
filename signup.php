...
<form action="signup.php" method ="POST" name="register_form">
  <table width="484" height="328" id="title">
    ...
    <tr>
      <td>&nbsp;</td>
        <td><input type="submit" name="submit" value="Sign Up"  onClick="return validateForm()"style="style="background-color:#CCCCCC; width::30px;height:30px"/>
		<input type="reset" name="clear" style="background-color:#CCCCCC; width:30px;height:30px">		</td>
      </tr>
  </table>
</form>
</td></tr></table>
